...
const FamousEquipment = () => {
  ...
  return (
    <div className="bg-base-300">
      ...
      <div className="py-5">
        <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 w-8/12 mx-auto gap-10 pt-10 pb-10">
          {famousEquipments.slice(4, 7).map((famous) => (
            <Famous key={famous._id} famous={famous}></Famous>
          ))}
        </div>
        <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-3 w-8/12 mx-auto gap-10 pb-10">
