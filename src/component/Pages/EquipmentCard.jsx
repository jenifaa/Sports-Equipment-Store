  ...
  return (
    <div>
      <div className="border p-6 rounded-xl bg-[#ffffff]">
        <div>
          <img
            className="w-full md:w-[300px] h-72 rounded-xl"
            src={photo}
            alt=""
          />
        </div>
        ...
        <div className="">
          <div className="">
            <span className="my-4 font-semibold mr-5">
              Available Products:{" "}
            </span>
            <span className="font-bold text-orange-600">{quantity}</span>
          </div>
          <div className="">
            <span className="my-4 font-semibold mr-5">Price: </span>
        ...
        <div>
          <Link to={`/equipment/${equipment._id}`}>
            <button className="px-4 py-2 bg-[#5C4E4E] text-white font-bold my-4">
              View Details
            </button>
          </Link>
        </div>
